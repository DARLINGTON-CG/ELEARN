...
class _LineChart extends StatelessWidget {
  ...
  SideTitles leftTitles({required GetTitleFunction getTitles}) => SideTitles(
        ...
        interval: 1,
        reservedSize: 40,
        getTextStyles: (context, value) =>GoogleFonts.alegreya(
          fontSize: 15,
  ...
  SideTitles get bottomTitles => SideTitles(
        ...
        margin: 10,
        interval: 1,
        getTextStyles: (context, value) => GoogleFonts.alegreya(fontSize: 15,fontWeight: FontWeight.bold, color: Color(0xABFFFFFF)),
        getTitles: (value) {
          switch (value.toInt()) {
            case 2:
              return 'SEPT';
